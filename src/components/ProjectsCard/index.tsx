...
export const ProjectsCard = ({ projectData, t }: Props) => {
  const iconByTecnologyName: Record<string, React.ReactNode> = {
    ...
    "Material-UI": (
      <img
        src="../../../public/icons/MaterialUI.svg"
        alt="Material-UI"
        className="w-6 h-6"
      />
    ),
    ...
    Zustand: (
      <img
        src="../../../public/images/ZustandLogo.png"
        alt="Tailwind"
        className="w-6 h-6"
      />
    ),
    "React-Query": (
      <img
        src="../../../public/icons/ReactQuery.svg"
        alt="React-Query"
        className="w-6 h-6"
      />
    ),
